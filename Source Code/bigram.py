...
text_file=sc.textFile("files")#Enter path of input files
file="new_lemmatizer.csv"#Enter path of lemmitization file
	...
	for w in word_pair:
		...
		for x in w1:
			for y in w2:
				 ...
				 map_values.append([','.join([x,y]),[location]])
...
final_cooccur.saveAsTextFile("/home/surabhi/Downloads/DIC/checking")#path of output file
